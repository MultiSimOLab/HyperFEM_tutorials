...
fibra = HGO_1Fiber(c1=10.0,c2=20.0)
physmodel_elec = IdealDielectric(ε=1.0)
physmodel= physmodel_mec+fibra+physmodel_elec
...
# Solve
x = solve!(comp_model; stepping=(nsteps=50, maxbisec=5), ProjectDirichlet=true, post=post_model)